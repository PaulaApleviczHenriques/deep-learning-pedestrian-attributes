...
Original file is located at
    https://colab.research.google.com/drive/13efxFAvEXmcIJsbcNF8glb7bAZcSPZhk
...
"""## Deep learning - CNN - EfficientNet B0
...
# Criar modelo com EfficientNet B0
...
for epoch in range(1, EPOCHS+1):
    ...
    if te_acc > best_acc:
        best_acc = te_acc
        torch.save(model.state_dict(), 'best_efficientnet_topcolor.pth')
        print(f"✓ Melhor modelo salvo! Acurácia: {best_acc*100:.2f}%")

print(f"\nAcurácia final: {best_acc*100:.1f}%")

# Avaliação final
model.load_state_dict(torch.load('best_efficientnet_topcolor.pth'))
model.eval()
y_true, y_pred = [], []
...
plt.title(f"Matriz de Confusão – Top Color com EfficientNet B0 (Acc: {best_acc*100:.1f}%)")
...
for epoch in range(1, EPOCHS+1):
    ...
    if te_acc > best_acc:
        best_acc = te_acc
        torch.save(model.state_dict(), 'best_efficientnet_bottomcolor.pth')
        print(f"✓ Melhor modelo salvo! Acurácia: {best_acc*100:.2f}%")

print(f"\nAcurácia final: {best_acc*100:.1f}%")

# Avaliação final
model.load_state_dict(torch.load('best_efficientnet_bottomcolor.pth'))
model.eval()
y_true, y_pred = [], []
...
plt.figure(figsize=(10, 10))
plt.imshow(cm_norm, interpolation="nearest", cmap='Blues')
plt.title(f"Matriz de Confusão – Bottom Color com EfficientNet B0 (Acc: {best_acc*100:.1f}%)")
plt.xticks(ticks=np.arange(NUM_CLASSES), labels=class_names, rotation=45, ha="right")
plt.yticks(ticks=np.arange(NUM_CLASSES), labels=class_names)
plt.xlabel("Predito")
plt.ylabel("Real")
...
for epoch in range(1, EPOCHS+1):
    ...
    if te_acc > best_acc:
        best_acc = te_acc
        torch.save(model.state_dict(), 'best_efficientnet_gender.pth')
        print(f"✓ Melhor modelo salvo! Acurácia: {best_acc*100:.2f}%")

print(f"\nAcurácia final: {best_acc*100:.1f}%")

# Avaliação final
model.load_state_dict(torch.load('best_efficientnet_gender.pth'))
model.eval()
y_true, y_pred = [], []
...
plt.imshow(cm_norm, interpolation="nearest", cmap='Blues')
plt.title(f"Matriz de Confusão – Gender com EfficientNet B0 (Acc: {best_acc*100:.1f}%)")
...
for epoch in range(1, EPOCHS+1):
    ...
    if te_acc > best_acc:
        best_acc = te_acc
        torch.save(model.state_dict(), 'best_efficientnet_bag.pth')
        print(f"✓ Melhor modelo salvo! Acurácia: {best_acc*100:.2f}%")

print(f"\nAcurácia final: {best_acc*100:.1f}%")

# Avaliação final
model.load_state_dict(torch.load('best_efficientnet_bag.pth'))
model.eval()
y_true, y_pred = [], []
...
plt.figure(figsize=(8, 8))
plt.imshow(cm_norm, interpolation="nearest", cmap='Blues')
plt.title(f"Matriz de Confusão – Bag com EfficientNet B0 (Acc: {best_acc*100:.1f}%)")
plt.xticks(ticks=np.arange(NUM_CLASSES), labels=class_names, rotation=0, ha="center")
plt.yticks(ticks=np.arange(NUM_CLASSES), labels=class_names)
plt.xlabel("Predito")
plt.ylabel("Real")
...
for epoch in range(1, EPOCHS+1):
    ...
    if te_acc > best_acc:
        best_acc = te_acc
        torch.save(model.state_dict(), 'best_efficientnet_hat.pth')
        print(f"✓ Melhor modelo salvo! Acurácia: {best_acc*100:.2f}%")

print(f"\nAcurácia final: {best_acc*100:.1f}%")

# Avaliação final
model.load_state_dict(torch.load('best_efficientnet_hat.pth'))
model.eval()
y_true, y_pred = [], []
...
plt.figure(figsize=(8, 8))
plt.imshow(cm_norm, interpolation="nearest", cmap='Blues')
plt.title(f"Matriz de Confusão – Hat com EfficientNet B0 (Acc: {best_acc*100:.1f}%)")
plt.xticks(ticks=np.arange(NUM_CLASSES), labels=class_names, rotation=0, ha="center")
plt.yticks(ticks=np.arange(NUM_CLASSES), labels=class_names)
plt.xlabel("Predito")
plt.ylabel("Real")
