...
Original file is located at
    https://colab.research.google.com/drive/1i308xPlvg2d4gjVK7A4K5BHSqWWq-o8d
...
SAVE_PATH = '/content/drive/MyDrive/Ciência da Computação/Experiência Criativa: Projeto Transformador II/best_efficientnet_multitask.pth'
...
model = EfficientNetMultiTask().to(DEVICE)
...
print("\nTreinando EfficientNet B0 Multi-Task...")
